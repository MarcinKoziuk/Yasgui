...
import { default as Yasqe, PartialConfig as YasqeConfig, RequestConfig } from "@marcinbk/yasqe";
import { default as Yasr, Config as YasrConfig } from "@marcinbk/yasr";
import { addClass, removeClass } from "@triply/yasgui-utils";
require("./index.scss");
require("@marcinbk/yasr/src/scss/global.scss");
if (window) {
